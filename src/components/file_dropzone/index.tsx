...
export const FileDropZone: React.FC<FileDropZoneProps> = ({
  ...
  const buttonClasses = useMemo(() => {
    const baseClasses =
      "relative block w-full border bg-card border-dashed p-12 text-center transition-all duration-200 ease-in-out focus:outline-2 focus:outline-offset-2 focus:outline-ring rounded-md";
  ...
  return (
    <div className="w-full">
      ...
      {error && (
        <div className="mt-2 py-2 px-4 rounded-md bg-destructive/10 border border-destructive/20">
