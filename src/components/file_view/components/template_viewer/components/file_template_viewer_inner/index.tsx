...
import {
  ...
  annotationPlainPreview,
  buildNewTextLabel,
  clamp01,
  emptySchema,
  parseNewTextLabelNumber,
  parseSchema,
} from "../../utilities";
import { useActiveAnnotationEditor } from "../../context/use_active_annotation_editor";
import { AnnotationDockedToolbar } from "../annotation_docked_toolbar";
import { AnnotationShapeToolbar } from "../annotation_shape_toolbar";
import { AnnotationToolbar } from "../annotation_toolbar";
import { PdfTemplateViewer } from "../pdf_template_viewer";
import { TemplateFloatingBar } from "../template_floating_bar";
...
>(function FileTemplateViewerInner(
  ...
  // Por defecto sí: quien no pasa `features` es Documentos, que sí puede guardar.
  const canSaveAs = features?.saveAs !== false;
  ...
  return (
    <div className="flex h-full min-h-0 w-full flex-col bg-background">
      <AnnotationToolbar
        ...
        onSaveAsPdf={canSaveAs ? openSaveAsDialog : undefined}
...
FileTemplateViewerInner.displayName = "FileTemplateViewerInner";

export { FileTemplateViewerInner };
