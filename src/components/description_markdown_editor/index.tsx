...
import {
  HEADING_MENU_ITEM_CLASS_NAME,
  HEADING_MENU_OPTIONS,
} from "./constants";
import type { DescriptionMarkdownEditorRef } from "./types";
...
DescriptionMarkdownEditor.displayName = "DescriptionMarkdownEditor";

export type { DescriptionMarkdownEditorRef } from "./types";
