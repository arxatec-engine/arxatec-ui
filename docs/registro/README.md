...
| 2026-08-11 | [SVG_CAMELCASE_GOOGLE_ISOTYPE.md](2026-08-11/SVG_CAMELCASE_GOOGLE_ISOTYPE.md) | Los tres `Invalid DOM property` de la consola de la plataforma salían de `GoogleIsotype`: 57 atributos SVG en kebab-case que React descartaba (el isotipo se renderizaba sin degradados ni recorte). Arreglado. | ✅ arreglado · ⏸ falta publicar en npm para que llegue a la plataforma | 2026-08-11 · `3fcfe44` · npm 0.1.59 vs local 0.1.58 · lint + `tsc -b` en verde |
