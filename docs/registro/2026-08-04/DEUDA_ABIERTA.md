...
| **D-4** | Sin `CLAUDE.md` ni convenciones escritas | ⏸ owner | raíz |
...
de pnpm. El repo tiene **`package-lock.json` y `pnpm-lock.yaml` a la vez**, y su
